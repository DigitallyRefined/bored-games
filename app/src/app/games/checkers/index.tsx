...
export default function CheckersIndexScreen() {
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]} edges={["top", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <ScreenHeader title="Checkers" backTo="/" />

          <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
            Jump, capture, and crown your way across the wooden board. Pick a way to play.
          </Text>

          <View style={styles.modeList}>
            <Pressable
              onPress={() => router.push("/games/checkers/local")}
              style={({ pressed }) => [
                styles.modeCard,
            ...
            <Pressable
              onPress={() => router.push("/games/checkers/online")}
              style={({ pressed }) => [
                styles.modeCard,
                { backgroundColor: theme.backgroundElement },
                pressed && styles.modeCardPressed,
