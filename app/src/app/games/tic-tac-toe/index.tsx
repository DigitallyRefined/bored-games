...
export default function TicTacToeIndexScreen() {
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]} edges={["top", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <ScreenHeader title="Tic-Tac-Toe" backTo="/" />

          <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
            Two players, three in a row. Pick a way to play.
          </Text>

          <View style={styles.modeList}>
            <Pressable
              onPress={() => router.push("/games/tic-tac-toe/local")}
              style={({ pressed }) => [
                styles.modeCard,
            ...
            <Pressable
              onPress={() => router.push("/games/tic-tac-toe/online")}
              style={({ pressed }) => [
                styles.modeCard,
                { backgroundColor: theme.backgroundElement },
                pressed && styles.modeCardPressed,
            ...
            >
              ...
              <Text style={[styles.modeDescription, { color: theme.textSecondary }]}>
                Create a room and play against a friend over the internet.
              </Text>
            </Pressable>
          </View>
        </View>
