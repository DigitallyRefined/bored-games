...
export default function BattleshipsIndexScreen() {
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]} edges={["top", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <ScreenHeader title="Battleships" backTo="/" />

          <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
            Place your fleet, then hunt down every last ship on the high seas.
            Pick a way to play.
          </Text>

          <View style={styles.modeList}>
            <Pressable
              onPress={() => router.push("/games/battleships/local")}
              style={({ pressed }) => [
                styles.modeCard,
            ...
            >
              ...
              <Text style={[styles.modeDescription, { color: theme.textSecondary }]}>
                Set up your ships on one device, fire a shot, then pass it over.
              </Text>
            </Pressable>

            <Pressable
              onPress={() => router.push("/games/battleships/online")}
              style={({ pressed }) => [
                styles.modeCard,
                { backgroundColor: theme.backgroundElement },
                pressed && styles.modeCardPressed,
            ...
            >
              ...
              <Text style={[styles.modeDescription, { color: theme.textSecondary }]}>
                Create a room and hunt a friend&apos;s fleet over the internet.
              </Text>
            </Pressable>
          </View>
        </View>
